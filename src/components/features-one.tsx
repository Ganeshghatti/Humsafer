                ...
                return(
                    <div className={`p-6  transition duration-500 rounded-3xl ${item.active ? 'hover:shadow-xl hover:shadow-slate-100 dark:hover:shadow-slate-800' : 'shadow-xl shadow-slate-100 dark:shadow-slate-800'}`} key={index}>
                        ...
                        <div className="content mt-7">
                            <Link to="" className="text-lg hover:text-orange-500 dark:text-white dark:hover:text-orange-500 transition-all duration-500 ease-in-out font-semibold">{item.title}</Link>
                            <p className="text-slate-400 mt-3">{item.desc}</p>
                            
                            <div className="mt-3">
                                <Link to="" className="hover:text-orange-500 dark:hover:text-orange-500 after:bg-orange-500 dark:text-white transition duration-500">Read More <i className="mdi mdi-arrow-right"></i></Link>
                            </div>
                        </div>
                    </div>
                )
