                ...
                <div className="grid md:grid-cols-12 items-center">
                    <div className="md:col-span-3">
                        <Link to="#" className="logo-footer">
                            <img src={logo} className="md:ms-0 h-10 mx-auto" alt=""/>
                        </Link>
                    </div>
